				...
				<div class="row">
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						...
						<a class="btn btn-danger pull-left" style="margin-top:-30px;margin-left:-90px" href="index.php"><i class="material-icons">arrow_back</i></a>
							<form class="form" method="post" action="php/forgotpass.php">
								<div class="header header-primary text-center header-danger">
									<h4>Forgot Password</h4>
									
								</div>
								<p class="text-divider">Enter your new password</p>
								<div class="content">
									...
									<div class="input-group">
										...
										<input type="password" name="cpass" placeholder="Confirm New Password..." class="form-control" />
									</div>
