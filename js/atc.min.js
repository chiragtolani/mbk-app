(function (w, d) {
    ...
    addtocalendar.languages = {
        de: "<i class='material-icons'>date_range</i>",
        en: "<i class='material-icons'>date_range</i>",
        es: "<i class='material-icons'>date_range</i>",
        fr: "<i class='material-icons'>date_range</i>",
        hi: "<i class='material-icons'>date_range</i>",
        "in": "<i class='material-icons'>date_range</i>",
        ja: "<i class='material-icons'>date_range</i>",
        ko: "<i class='material-icons'>date_range</i>",
        pt: "<i class='material-icons'>date_range</i>",
        ru: "<i class='material-icons'>date_range</i>",
        uk: "<i class='material-icons'>date_range</i>",
        zh: "<i class='material-icons'>date_range</i>"
    };
