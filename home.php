    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-danger" style="margin-top:5%; display:inline-block;">
                    <div class="container">
                        <div class="navbar-header">
                        <h1 class="navbar-brand"><script type="text/javascript">
                          var m_names = ["January", "February", "March", 
                          "April", "May", "June", "July", "August", "September", 
                          "October", "November", "December"];
                        ...
                        <div class="collapse navbar-collapse" id="example-navbar-danger" style="margin-right:3%; margin-top:2%;; display:inline-block;">
 ...
 //Connect to the mySQL server.
    if (mysqli_connect_errno()) //Check if its connected or not.
        { 
            ...
            $get_room_id="select r_id,r_name,capacity from rooms order by capacity;"; // SQL query to get room id from the database.
            $room_id=array();
        ...
        while($i<(sizeof($room_id)/$col_count)){ //check for number of rows
            ...
            echo "<tr id='table-layout-inline'>"; //creating a table row
                while($j<$col_count){ //check for number of columns
                    ...
                    <div class='card-header success' data-background-color=green style='padding: 2px 2px 2px 12px;' id='".$id."' >
                                <h5 style='display:inline-block;'>".$capacity[$room_count]."</h5>
                                    
									<i class='material-icons unselectable' unselectable='on' style='font-size:20px; display:inline-block;'>group</i>
								</div>
